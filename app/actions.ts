...
//shema pour validation des inputs pour la creation d'un produit avec zod
...
//fonction pour créer un produit dans la bd
export async function SellProduct(prevState: any, formData: FormData) {
  ...
  return redirect(`/product/${data.id}`); //redirection vers la page du produit créer
}
